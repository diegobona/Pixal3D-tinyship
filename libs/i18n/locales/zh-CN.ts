...
export const zhCN: Locale = {
  ...
  pixal3d: {
    generator: {
      badge: "图片转 3D",
      heroTitle: "图片转 3D",
      title: "用一张图片生成 GLB 3D 模型",
      subtitle: "将任意产品图片转换为可下载的 GLB 3D 模型。",
      imageLabel: "参考图片",
      imageHint: "v1 阶段支持单张图片输入。",
      ...
      trialTitle: "包含一次免费试用",
      trialDescription: "游客可以生成一次示例模型。登录后可使用积分继续生成并保存历史记录。",
      stylePreset: "游戏开发：高模",
      cleanTopology: "拓扑清理",
      pbrMaterials: "PBR 材质",
      advanced: "高级",
      ...
      previewTitle: "GLB 预览",
      previewHeading: "预览并下载你的模型",
      outputTitle: "GLB 输出",
      outputDescription: "任务成功后会返回可在浏览器预览的 GLB 文件，并保持后续真实 3D provider 所需的统一 API 结构。",
      downloadButton: "下载 GLB",
      status: {
        idle: "上传图片后开始。",
        ready: "图片已就绪，补充描述后即可生成。",
        creating: "正在创建 3D 任务...",
        processing: "Mock provider 正在构建 GLB...",
        succeeded: "3D 模型已生成。"
      },
      viewer: {
        idle: "生成后的 GLB 预览会显示在这里。",
        loading: "正在加载 3D 预览...",
        error: "GLB 预览加载失败。"
      },
      errors: {
        unsupportedImage: "请上传 JPG、PNG、WebP 或 BMP 图片。",
        imageTooLarge: "图片大小不能超过 10 MB。",
        uploadFailed: "无法读取图片，请尝试其他文件。",
        imageRequired: "请先上传参考图片。",
        promptRequired: "生成前请填写模型描述。",
        generationFailed: "3D 生成失败。",
        statusFailed: "无法查询 3D 任务状态。",
        timeout: "3D 生成超时，请重试。",
