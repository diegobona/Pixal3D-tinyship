  ...
  pixal3d: {
    generator: {
      ...
      errors: {
        ...
        generateDisabledSignIn: "Sign in and subscribe for faster, stable generation, never offline. Free trial is available above.",
        generateDisabledSubscribeRequired: "Subscribe to generate models",
        generateDisabledFreeTrialAbove: "Faster, stable generation, never offline. Free trial is available above.",
