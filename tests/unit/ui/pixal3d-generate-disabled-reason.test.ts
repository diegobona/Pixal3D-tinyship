...
const labels = {
  signInRequired: 'Sign in and subscribe for faster and more stable generation, never offline. Free trial is available above.',
...
describe('getPixal3DGenerateDisabledReason', () => {
  ...
  test('asks unauthenticated users to sign in first', () => {
    expect(getPixal3DGenerateDisabledReason({
      ...
      isProcessing: false,
      labels,
    })).toBe('Sign in and subscribe for faster and more stable generation, never offline. Free trial is available above.');
  });
