...
export const en: Locale = {
  ...
  pixal3d: {
    generator: {
      ...
      trialDescription: "Guests can generate one sample model. Sign in to keep generating with credits and save your history.",
      ...
      hfTrialDescription: "Use the embedded HuggingFace demo for one free trial. This temporary demo is separate from credits and history.",
      hfTrialQueueLabel: "Current queue",
      hfTrialClose: "Close demo",
      generateButton: "Generate Model",
      generatingButton: "Building model...",
      previewTitle: "GLB preview",
      previewHeading: "Preview and download your model",
      outputTitle: "GLB output",
      outputDescription: "Successful tasks return a browser-ready GLB file with the same API shape planned for the real 3D provider.",
      downloadButton: "Download GLB",
      status: {
        idle: "Upload an image to start.",
        ready: "Image ready. Add detail and generate.",
        creating: "Creating 3D task...",
        processing: "Mock provider is building the GLB...",
        succeeded: "3D model is ready."
      },
      viewer: {
        idle: "Generated GLB preview will appear here.",
        loading: "Loading 3D preview...",
        error: "The GLB preview could not be loaded."
      },
      errors: {
        ...
        promptRequired: "Add a model brief before generating.",
